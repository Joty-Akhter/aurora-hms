# Module: HR – Comprehensive Human Resources Management System
...
- **[payroll_benefits_administration.md](payroll_benefits_administration.md)**
  ...
  - Salary management, benefits enrollment, compensation planning, Provident Fund administration, and incentives management
- **[salary_management_requirements.md](salary_management_requirements.md)**
  - *Detailed salary structure, salary components, and employee salaries*
  - Salary grades/bands, pay ranges, configurable earnings and deductions, employee salary assignment, revision history, and payslip derivation
- **[employee_loans_requirements.md](employee_loans_requirements.md)**
  - *Employee loans and salary advance*
  - Eligibility, loan categories, limits, repayment (including partial and combined installments), payroll recovery, PF-independent rules, and resignation settlement against PF, salary, or other dues
