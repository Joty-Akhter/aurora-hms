...
--changeset easyops:022-enable-hr-module splitStatements:false
--comment: Enable HR module in frontend module config. hr-service has no own Liquibase runner, so this
--         must be seeded centrally. pharma-service already does this as a side-effect of its own
--         migration, but Aurora HMS runs without pharma-service.
