...
class StockControllerRbacTest {
    ...
    @Test
    void getStock_forbiddenWhenViewDenied() {
        InventoryRbacService rbac = new InventoryRbacService(new DenyingRbacClient("inventory_view"));
        StockController controller = new StockController(null, rbac);

        assertThatThrownBy(() -> controller.getStock(USER_HEADER, ORG, null, null))
