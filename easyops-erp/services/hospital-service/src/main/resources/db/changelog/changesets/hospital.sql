...
DROP TRIGGER IF EXISTS update_lab_results_updated_at ON ehr.lab_results;
CREATE TRIGGER update_lab_results_updated_at
    BEFORE UPDATE ON ehr.lab_results
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_critical_alerts_updated_at ON ehr.lab_critical_value_alerts;
...
-- Update triggers
DROP TRIGGER IF EXISTS update_lab_result_problems_updated_at ON ehr.lab_result_problems;
CREATE TRIGGER update_lab_result_problems_updated_at
    BEFORE UPDATE ON ehr.lab_result_problems
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_lab_result_medications_updated_at ON ehr.lab_result_medications;
CREATE TRIGGER update_lab_result_medications_updated_at
    BEFORE UPDATE ON ehr.lab_result_medications
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_lab_result_clinical_notes_updated_at ON ehr.lab_result_clinical_notes;
CREATE TRIGGER update_lab_result_clinical_notes_updated_at
    BEFORE UPDATE ON ehr.lab_result_clinical_notes
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_lab_result_values_updated_at ON ehr.lab_result_values;
CREATE TRIGGER update_lab_result_values_updated_at
    BEFORE UPDATE ON ehr.lab_result_values
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_drug_lab_alerts_updated_at ON ehr.drug_lab_interaction_alerts;
...
-- Apply update triggers
DROP TRIGGER IF EXISTS update_imaging_orders_updated_at ON ehr.imaging_orders;
CREATE TRIGGER update_imaging_orders_updated_at
    BEFORE UPDATE ON ehr.imaging_orders
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_imaging_studies_updated_at ON ehr.imaging_studies;
CREATE TRIGGER update_imaging_studies_updated_at
    BEFORE UPDATE ON ehr.imaging_studies
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_imaging_critical_alerts_updated_at ON ehr.imaging_critical_finding_alerts;
CREATE TRIGGER update_imaging_critical_alerts_updated_at
    BEFORE UPDATE ON ehr.imaging_critical_finding_alerts
    FOR EACH ROW
    EXECUTE FUNCTION ehr.update_updated_at_column();

DROP TRIGGER IF EXISTS update_imaging_attachments_updated_at ON ehr.imaging_image_attachments;
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_imaging_study_clinical_notes_updated_at ON ehr.imaging_study_clinical_notes;
CREATE TRIGGER update_imaging_study_clinical_notes_updated_at
    BEFORE UPDATE ON ehr.imaging_study_clinical_notes
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_imaging_study_problems_updated_at ON ehr.imaging_study_problems;
CREATE TRIGGER update_imaging_study_problems_updated_at
    BEFORE UPDATE ON ehr.imaging_study_problems
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_imaging_study_medications_updated_at ON ehr.imaging_study_medications;
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_medications_updated_at ON ehr.medications;
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_medication_reconciliation_updated_at ON ehr.medication_reconciliation;
...
-- Trigger for updated_at
DROP TRIGGER IF EXISTS update_pdmp_query_results_updated_at ON ehr.pdmp_query_results;
...
-- Triggers for updated_at
DROP TRIGGER IF EXISTS update_pharmacy_networks_updated_at ON ehr.pharmacy_networks;
CREATE TRIGGER update_pharmacy_networks_updated_at
    BEFORE UPDATE ON ehr.pharmacy_networks
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_prescription_transmissions_updated_at ON ehr.prescription_transmissions;
