...
@Entity
@Table(name = "lab_result_medications", schema = "ehr")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EntityListeners(AuditingEntityListener.class)
public class LabResultMedication {
    ...
    @Builder.Default
    private LinkType linkType = LinkType.MONITORS;
    ...
    public enum LinkType {
        MONITORS, AFFECTED_BY, AFFECTS, CONTRAINDICATED, OTHER
    }
