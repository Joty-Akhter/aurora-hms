 ...
 */
@Entity
@Table(name = "imaging_study_clinical_notes", schema = "ehr")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@EntityListeners(AuditingEntityListener.class)
public class ImagingStudyClinicalNote {
    ...
    @Builder.Default
    private LinkType linkType = LinkType.REFERENCED;
    ...
    public enum LinkType {
        REFERENCED, DISCUSSED, INTERPRETED, DOCUMENTED, ORDERED, OTHER
    }
