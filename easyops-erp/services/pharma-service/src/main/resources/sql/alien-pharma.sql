...
-- ============================================================================
-- STEP 14: INSERT ALIEN PHARMA Terrirory Management (TERRITORY)
-- ============================================================================
...
-- ============================================================================
-- STEP 15: INSERT ALIEN PHARMA Terrirory Management (AREA)
-- ============================================================================
...
SELECT
	...
	(SELECT id FROM pharma.divisions WHERE code = 'Dhaka-001'),
	(SELECT id FROM pharma.regions WHERE code = 'Dhaka-002'),
	(SELECT id FROM pharma.territories WHERE name = 'Dhaka'),
	area_name,
	area_name || '-001',
	'Dhaka Division',
	true,
...
insert into pharma.areas
(organization_id, division_id, region_id, territory_id, name, code, description, is_active,   status)
SELECT
(SELECT id FROM admin.organizations WHERE code = 'ALIEN_PHARMA'),
(SELECT id FROM pharma.divisions WHERE code = 'Dhaka-001'),
(SELECT id FROM pharma.regions WHERE code = 'Dhaka-002'),
(SELECT id FROM pharma.territories WHERE name = 'Dhaka-2'),		
area_name_dhaka_2,
area_name_dhaka_2 || '-001',		
...
(SELECT id FROM pharma.divisions WHERE code = 'Dhaka-001'),
(SELECT id FROM pharma.regions WHERE code = 'Dhaka-002'),
(SELECT id FROM pharma.territories WHERE name = 'Dhaka-1'),		
area_name_dhaka_1,
area_name_dhaka_1 || '-001',		
'Dhaka Division',true,'ACTIVE'
FROM unnest(ARRAY[
'Gulshan',
'Mirpur-10',
...
(SELECT id FROM pharma.divisions WHERE code = 'Mymensingh-001'),
(SELECT id FROM pharma.regions WHERE code = 'Mymensingh-002'),
(SELECT id FROM pharma.territories WHERE name = 'Mymensingh'),		
area_name_mym,
area_name_mym || '-001',		
...
(SELECT id FROM pharma.divisions WHERE code = 'Mymensingh-001'),
(SELECT id FROM pharma.regions WHERE code = 'Mymensingh-002'),
(SELECT id FROM pharma.territories WHERE name = 'Gazipur'),		
area_name_gaz,
area_name_gaz || '-001',		
'Mymensingh Division',true,'ACTIVE'
FROM unnest(ARRAY[
...
(SELECT id FROM pharma.divisions WHERE code = 'Mymensingh-001'),
(SELECT id FROM pharma.regions WHERE code = 'Mymensingh-002'),
(SELECT id FROM pharma.territories WHERE name = 'Kishoregonj'),		
area_name_kig,
area_name_kig || '-001',		
'Mymensingh Division',true,'ACTIVE'
FROM unnest(ARRAY[
...
(SELECT id FROM pharma.divisions WHERE code = 'Rangpur-001'),
(SELECT id FROM pharma.regions WHERE code = 'Rangpur-002'),
(SELECT id FROM pharma.territories WHERE name = 'Rangpur'),		
area_name_rng,
area_name_rng || '-001',		
...
(SELECT id FROM pharma.divisions WHERE code = 'Sylhet-001'),
(SELECT id FROM pharma.regions WHERE code = 'Sylhet-002'),
(SELECT id FROM pharma.territories WHERE name = 'Sylhet'),		
area_name_sy,
area_name_sy || '-001',		
...
-- ============================================================================
-- STEP 16: INSERT ALIEN PHARMA Warehouses
-- ============================================================================
...
------------------------ Update AREAs Warehouse IDs ---------------------

UPDATE pharma.areas a
